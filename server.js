...
require('fs').writeFileSync('/tmp/backend_heartbeat.txt', 'Backend loaded at: ' + new Date().toISOString());
...
const server = app.listen(PORT, async () => {
  ...
  console.log(`📍 API Base URL: http://localhost:${PORT}/api/v1 (AI MODIFIED)`);
